<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/customer.Master" AutoEventWireup="true"
    CodeBehind="customerDashboard.aspx.cs" Inherits="MiniProject.Customer.customerDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="dashboard">
            ...
            <div class="dashboard-card">
                ...
                <div class="card">
                    <h3>Total Tickets</h3>
                    <asp:Label ID="lblCreatedTicket" CssClass="total" runat="server" Text="0"></asp:Label>
                </div>
            </div>
        </div>
</asp:Content>
