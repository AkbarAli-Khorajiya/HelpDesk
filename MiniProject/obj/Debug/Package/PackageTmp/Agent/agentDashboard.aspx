<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/agent.Master" AutoEventWireup="true"
    CodeBehind="agentDashboard.aspx.cs" Inherits="MiniProject.Agent.agentDashboard" %>
...
<div class="dashboard">
            ...
            <div class="dashboard-card">
                ...
                <div class="card">
                    ...
                    <asp:Label ID="lblAssignedTicket" CssClass="total" runat="server" Text="0"></asp:Label>
                </div>
            </div>
        </div>
</asp:Content>
