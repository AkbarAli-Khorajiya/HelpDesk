<%@ Page Title="" Language="C#" MasterPageFile="~/Agent/agent.Master" AutoEventWireup="true"
    CodeBehind="ViewTicket.aspx.cs" Inherits="MiniProject.Agent.ViewTicket" %>
            ...
            $(document).ready(function () {
                ...
                $("#btnSendMsg").click(async function () {
                    ...
                    await $.ajax({
                        ...
                        data: JSON.stringify({ message: message, ticket_Id: ticketId, customer_Name: customerName }),
                ...
                function getChatMessages() {
                    $.ajax({
                        ...
                        data: JSON.stringify({ ticket_Id: ticketId, customer_Name: customerName }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
                            $(".loader-sub").fadeOut();
                ...
                $(".ddlStatusChanged").change(async function () {
                    let selectedValue = $(this).val();
                    $(".loader").fadeIn();
                    await $.ajax({
                        type: "POST",
                        url: "ViewTicket.aspx/UpdateStatus",
                        data: JSON.stringify({ status: selectedValue, ticket_Id: ticketId }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
        ...
        <div class="main-container">
            <div class="container">
                <div class="header">
                    ...
                    <asp:DropDownList title="change status" runat="server" ID="ddlStatusChange"
                        CssClass="ddlStatusChanged">
                ...
                <div class="main-card">
                    <div class="sub-main">
                        ...
                        <div class="card">
                            <asp:Label ID="lblNameTitle" runat="server" CssClass="title" Text="Name:"></asp:Label>
                            <asp:Label ID="lblName" class="lblName" runat="server"></asp:Label>
                            <asp:Label ID="lblEmailTitle" runat="server" CssClass="title" Text="Email:"></asp:Label>
            ...
            <div class="container-conversation">
                ...
                <p class="head-title">Conversation</p>
